...
using MajoranaPolynomialMap =
    ankerl::unordered_dense::map<MajoranaString, ff_complex, MajoranaStringHash>;
...
struct MajoranaString {
    ...
    MajoranaString(const std::vector<int>& supp) : alpha(0) {
        ...
        for (i = 0; i < supp.size(); i++) {
            ...
            if (supp[i] < 0 || supp[i] >= ff_dbl_ulong::DIGITS) {
                throw_error("Invalid MajoranaString (mode index "
                            << supp[i] << " invalid, should be between 0 and "
                            << ff_dbl_ulong::DIGITS - 1 << ")");
            }
            alpha.set(supp[i]);
        }
    }
    ...
    std::uint64_t hash() const { return alpha.hash(); }

    int extent() const { return ff_dbl_ulong::DIGITS - alpha.countl_zero(); };
...
struct MajoranaStringHash {
    ...
    std::uint64_t operator()(const MajoranaString& a) const { return a.hash(); }
};
...
struct MajoranaMonomial {
    ...
    MajoranaMonomial(const std::vector<int>& supp, const ff_complex& coeff)
        : s(supp), coeff(coeff) {};
    MajoranaMonomial(const ff_dbl_ulong& alpha, const ff_complex& coeff)
        : s(alpha), coeff(coeff) {};
...
struct MajoranaPolynomial {
    ...
    MajoranaPolynomial() {};
    explicit MajoranaPolynomial(const ff_complex& v) {
        terms[MajoranaString()] = v;
    }  // constant term equal to v
    ...
    MajoranaPolynomial(const std::vector<MajoranaString>& a,
                       const std::vector<ff_complex>& coeffs) {
    ...
    // In-place addition
    MajoranaPolynomial& operator+=(const ff_complex& b) {
        if (b != ff_complex(0, 0)) {
            terms[MajoranaString()] += b;
            inplace_compress(MajoranaString());
        }
        return *this;
    };
    MajoranaPolynomial& operator+=(const MajoranaString& b) {
        terms[b] += 1;
        inplace_compress(b);
        return *this;
    };
    MajoranaPolynomial& operator+=(const MajoranaMonomial& b) {
        terms[b.s] += b.coeff;
...
MajoranaMonomial operator*(const MajoranaString& b, const ff_complex& a) {
    return MajoranaMonomial(b, a);
}
MajoranaMonomial operator*(const ff_complex& a, const MajoranaString& b) {
    return MajoranaMonomial(b, a);
}

MajoranaMonomial operator*(const MajoranaMonomial& a, const ff_complex& b) {
    return MajoranaMonomial(a.s, a.coeff * b);
}
MajoranaMonomial operator*(const ff_complex& a, const MajoranaMonomial& b) {
    return MajoranaMonomial(b.s, b.coeff * a);
}

MajoranaPolynomial operator+(const ff_complex& a, const MajoranaString& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const ff_complex& a, const MajoranaMonomial& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const ff_complex& a, const MajoranaPolynomial& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}

MajoranaPolynomial operator+(const MajoranaString& a, const ff_complex& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaMonomial& a, const ff_complex& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaPolynomial& a, const ff_complex& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}

MajoranaPolynomial operator+(const MajoranaString& a, const MajoranaString& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaString& a, const MajoranaMonomial& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaString& a, const MajoranaPolynomial& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaMonomial& a, const MajoranaString& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaMonomial& a, const MajoranaMonomial& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaMonomial& a, const MajoranaPolynomial& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaPolynomial& a, const MajoranaString& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaPolynomial& a, const MajoranaMonomial& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
MajoranaPolynomial operator+(const MajoranaPolynomial& a, const MajoranaPolynomial& b) {
    MajoranaPolynomial c(a);
    c += b;
    return c;
}
...
MajoranaPolynomial operator*(const ff_complex& b, const MajoranaPolynomial& a) {
    MajoranaPolynomial c(a);
    c *= b;
    return c;
}
...
MajoranaMonomial operator*(const MajoranaString& a, const MajoranaMonomial& b) {
    return b.coefficient() * (a * b.majorana_string());
}
MajoranaMonomial operator*(const MajoranaMonomial& a, const MajoranaString& b) {
    return a.coefficient() * (a.majorana_string() * b);
}
MajoranaMonomial operator*(const MajoranaMonomial& a, const MajoranaMonomial& b) {
    return a.coefficient() * b.coefficient() * (a.majorana_string() * b.majorana_string());
}
MajoranaPolynomial operator*(const MajoranaPolynomial& a, const MajoranaPolynomial& b) {
    MajoranaPolynomial c(a);
    c *= b;
...
MajoranaMonomial MajoranaMonomial::permute(const std::vector<int>& map) const {
    return coeff * s.permute(map);
}
...
bool operator==(const MajoranaString& a, const ff_complex& b) {
    return a.alpha == 0 && b == ff_complex(1, 0);
}
bool operator==(const MajoranaString& a, const MajoranaString& b) { return a.alpha == b.alpha; }
bool operator==(const MajoranaString& a, const MajoranaMonomial& b) {
    return a == b.s && b.coeff == ff_complex(1, 0);
}
bool operator==(const MajoranaString& a, const MajoranaPolynomial& b) {
    return MajoranaPolynomial(a) == b;
}

bool operator==(const MajoranaMonomial& a, const ff_complex& b) {
    return a.s.alpha == 0 && a.coeff == b;
}
bool operator==(const MajoranaMonomial& a, const MajoranaString& b) {
    return a.s == b && a.coeff == ff_complex(1, 0);
}
bool operator==(const MajoranaMonomial& a, const MajoranaMonomial& b) {
    return a.s == b.s && a.coeff == b.coeff;
}
bool operator==(const MajoranaMonomial& a, const MajoranaPolynomial& b) {
    return MajoranaPolynomial(a) == b;
}

bool operator==(const MajoranaPolynomial& a, const ff_complex& b) {
    return a == MajoranaPolynomial(b);
}
bool operator==(const MajoranaPolynomial& a, const MajoranaString& b) {
    return a == MajoranaPolynomial(b);
}
bool operator==(const MajoranaPolynomial& a, const MajoranaMonomial& b) {
    return a == MajoranaPolynomial(b);
}
...
std::ostream& operator<<(std::ostream& os, const MajoranaString& a) {
    return os << a.to_compact_string();
}
std::ostream& operator<<(std::ostream& os, const MajoranaMonomial& a) {
    return os << a.to_compact_string();
}
std::ostream& operator<<(std::ostream& os, const MajoranaPolynomial& p) {
...
MajoranaMonomial MajoranaString::commutator(const MajoranaMonomial& b) const {
    return b.coeff * commutator(b.s);
}

MajoranaMonomial MajoranaMonomial::commutator(const MajoranaString& b) const {
    return coeff * s.commutator(b);
}
MajoranaMonomial MajoranaMonomial::commutator(const MajoranaMonomial& b) const {
...
MajoranaPolynomial MajoranaPolynomial::commutator(const MajoranaString& b) const {
    return commutator(MajoranaPolynomial(b));
}
MajoranaPolynomial MajoranaPolynomial::commutator(const MajoranaMonomial& b) const {
    return commutator(MajoranaPolynomial(b));
}

MajoranaPolynomial MajoranaString::commutator(const MajoranaPolynomial& b) const {
    return MajoranaPolynomial(*this).commutator(b);
}
MajoranaPolynomial MajoranaMonomial::commutator(const MajoranaPolynomial& b) const {
    return MajoranaPolynomial(*this).commutator(b);
}

bool MajoranaString::commutes(const MajoranaMonomial& b) const { return commutes(b.s); }
bool MajoranaString::commutes(const MajoranaPolynomial& b) const {
    return b.commutator(*this).is_zero(0);
}
bool MajoranaMonomial::commutes(const MajoranaPolynomial& b) const {
    return b.commutator(*this).is_zero(0);
}

bool MajoranaPolynomial::commutes(const MajoranaString& b) const {
    return commutator(b).is_zero(0);
}
bool MajoranaPolynomial::commutes(const MajoranaMonomial& b) const {
    return commutator(b).is_zero(0);
}
bool MajoranaPolynomial::commutes(const MajoranaPolynomial& b) const {
    return commutator(b).is_zero(0);
}
