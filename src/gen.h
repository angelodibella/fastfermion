...
std::tuple<std::vector<PauliString>, std::vector<PauliString>, std::vector<PauliString>> paulis(
    int n) {
...
std::vector<PauliString> paulistrings(
    int n, int degree,
    std::function<bool(const std::vector<int>&, const std::vector<char>&)> filter_fun) {
...
std::vector<PauliString> paulistrings(int n, int degree) {
    return paulistrings(n, degree,
                        [](const std::vector<int>& s, const std::vector<char>& a) { return true; });
}
...
std::vector<FermiString> fermistrings(
    int n, int degree,
    std::function<bool(const std::vector<int>&, const std::vector<int>&)> filter_fun) {
...
std::vector<FermiString> fermistrings(int n, int degree) {
    return fermistrings(
        n, degree,
        [](const std::vector<int>& cre_s, const std::vector<int>& ann_s) { return true; });
}
...
std::vector<MajoranaString> majoranastrings(
    int n, int degree, std::function<bool(const std::vector<int>&)> filter_fun) {
