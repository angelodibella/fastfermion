...
struct FockState {
    ...
    std::vector<int> occ() { return b.support(); }
    ...
    ff_complex operator()(const FermiMonomial& a) const { return a.coeff * (*this)(a.s); }
    ...
    ff_complex operator()(const MajoranaMonomial& a) const { return a.coeff * (*this)(a.s); }
